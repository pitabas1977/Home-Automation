...
<body>
	...
	<table>
		...
		<?php
			...
			foreach ($All_courses as $course2) { ?>
				...
				<td>
					...
					if($course2['status']=="1")
						...
						echo
"<a href=off3.php?id=".$course2['id']." class='btn red'>OFF</a>";
					else
						echo
"<a href=on3.php?id=".$course2['id']." class='btn green'>ON</a>";
					?>
			</tr>
		<?php
				}
